...
<ul class="menu">
    ...
    <li class="sidebar-item has-sub {{ Request::is('masuk*') || Request::is('keluar*') ? 'active' : '' }}">
        <a href="#" class='sidebar-link'>
        ...
        <ul class="submenu">
            ...
            <li class="submenu-item {{ Request::is('masuk*') ? 'active' : '' }}">
                <a href="{{ route('masuk.index') }}" class="submenu-link">
                  Barang Masuk</a>
            </li>
            
            <!-- Barang Keluar -->
            <li class="submenu-item {{ Request::is('keluar*') ? 'active' : '' }}">
                <a href="{{ route('keluar.index') }}" class="submenu-link">Barang Keluar</a>
            </li>
