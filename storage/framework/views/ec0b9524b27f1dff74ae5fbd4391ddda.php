...
<ul class="menu">
    ...
    <li class="sidebar-item has-sub <?php echo e(Request::is('kategori*') || Request::is('lokasi*')  ? 'active' : ''); ?>">
        ...
        <ul class="submenu">
             <!-- kategori -->
            <li class="submenu-item <?php echo e(Request::is('kategori*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('kategori.index')); ?>" class="submenu-link">Kategori</a>
            </li>
            <!-- lokasi -->
            <li class="submenu-item <?php echo e(Request::is('lokasi*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('lokasi.index')); ?>" class="submenu-link">Lokasi</a>
            </li>
        </ul>

    <li class="sidebar-item has-sub <?php echo e(Request::is('masuk*') || Request::is('keluar*') ? 'active' : ''); ?>">
        <a href="#" class='sidebar-link'>
        ...
        <ul class="submenu">
            ...
            <!-- Barang Masuk -->
            <li class="submenu-item <?php echo e(Request::is('masuk*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('masuk.index')); ?>" class="submenu-link">
                  Barang Masuk</a>
            </li>
            
            <!-- Barang Keluar -->
            <li class="submenu-item <?php echo e(Request::is('keluar*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('keluar.index')); ?>" class="submenu-link">Barang Keluar</a>
            </li>
...
<!--<script>
    const username = "Yuni Rochmawati";
    document.getElementById("username").textContent = username;
</script>--><?php /**PATH C:\laragon\www\inventaris\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>